...
const SessionCard = ({ title, description, time, dateLabel, isTomorrow }) => {
  return (
    <div className="bg-[#F9FAFB] rounded-[2rem] p-6 mb-4 flex flex-col md:flex-row items-center justify-between gap-4 shadow-sm border border-gray-100">
      ...
      <div className="flex-1 text-right w-full">
        ...
        <div className="flex justify-start items-center gap-3 mb-3">
             ...
             <div className="text-[#EF4444] border border-[#EF4444] px-4 py-1 rounded-full font-bold bg-white text-sm">
                {dateLabel}
             </div>

             {/* Time (Second/Left of Date) */}
      ...
      <div className="w-full md:w-auto flex-shrink-0">
         <button className="bg-[#8BAA36] hover:bg-[#7a962e] text-white font-bold py-3 px-8 rounded-full flex items-center justify-center gap-3 transition-colors w-full md:w-auto shadow-sm text-lg group">
            {/* Text on Right */}
            <span>انضم الان</span>
